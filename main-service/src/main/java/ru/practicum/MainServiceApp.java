...
public class MainServiceApp {
  ...
  public static void main(String[] args) {
    ...
    checkStatConnection(context);
  }

  static void checkStatConnection(final ConfigurableApplicationContext context) {

    final StatsClient statsClient = context.getBean(StatsClient.class);
